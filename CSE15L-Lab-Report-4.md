...
8.
 I then pressed `<up><up><enter>` to run the tester again. I only had to press up twice since the command was only 2 up in the search history.  This ran the tests again and showed that they now succeded.
